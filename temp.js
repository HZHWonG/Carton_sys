...
async function handleTable(response) {
    ...
    for (const carton of cartons) {
        ...
        row.innerHTML = `
            <td style="text-align: center;">${carton.id}</td>
            <td style="text-align: center;">${carton.customer_name}</td>
            ...
            <td style="text-align: center;">${carton.box_name}</td>
            <td style="text-align: center;">${carton.material}</td>
            <td style="text-align: center;">${carton.material_size}</td>
            <td style="text-align: center;">${carton.remarks}</td>
